...
export function FeatureGridBackground({ className }: { className?: string }) {
	return (
		<div
			className={cn(
		...
		>
			<div className="absolute -top-10 left-1/2 h-[150%] w-[150%] -translate-x-1/2 opacity-60 [mask-image:radial-gradient(ellipse_at_top,white,transparent_70%)]">
				<GridPattern
					width={22}
					height={22}
					x="-12"
					...
					className="absolute inset-0 h-full w-full fill-gold/10 stroke-white/10 mix-blend-screen"
				/>
			</div>
		</div>
	);
